...
const linkedinUrl =
  process.env.LINKEDIN ?? 'https://www.linkedin.com/in/samuele-lo-truglio/';
const githubUrl = process.env.GITHUB ?? 'https://github.com/slotruglio';
const innovationDays =
  process.env.INNOVATIONDAYS ??
  'https://www.economysicilia.it/innovation-days-palermo-vince-il-progetto-tlf-di-una-tuta-antinfortunistica-ultratecnologica/';
